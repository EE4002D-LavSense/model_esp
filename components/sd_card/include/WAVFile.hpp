...
typedef struct _wav_header
{
  ...
  int byte_rate = 64000;      // Number of bytes per second. sample_rate * num_channels * Bytes Per Sample = 44100 * 1 * 4
  short sample_alignment = 4; // num_channels * Bytes Per Sample = 1 * 4
  short bit_depth = 32;       // Number of bits per sample
